          ...
          <section className="py-8 xl:py-12">
            <div className="container mx-auto px-4 max-w-5xl">
              <div className="mb-8 text-center">
                <h1 className="text-3xl font-bold mb-2">Privacy Policy (IBC Investment Platform)</h1>
                <p className="text-sm text-muted-foreground">Effective Date: 03-July-2025</p>
                <p className="mt-2">IBC is committed to protecting your privacy. This policy outlines how we collect, use, store, and share your data.</p>
              </div>
              <div className="space-y-8 bg-card border rounded-lg p-6 shadow">
                ...
                <section>
                  ...
                  <p>IBC uses cookies to enhance user experience and collect statistical data. You may disable cookies in your browser settings.</p>
                </section>
                <section>
